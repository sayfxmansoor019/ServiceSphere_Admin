...
type TServiceProviderInfoCardValues = {
  data: any;
};

const ServiceProviderInfoCard = ({ data }: TServiceProviderInfoCardValues) => {
  return (
        ...
        <div className="row mt-4">
          <div className="col-md-6">
            <div className="d-flex align-items-center">
              <div className="image">
                <img src={data?.image ? data.image : Provider} alt="" />
              </div>
              <div className="ms-3">
                <h6 className="fw-medium">{data?.name}</h6>
...
export default ServiceProviderInfoCard;
